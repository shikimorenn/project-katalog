...
const ActionList = () => {
  ...
  const products = [
    {
      id: 1,
      title: "Action Warrior Legends",
      desc: "Fast-paced combat adventure with intense battle mechanics.",
      oldPrice: "Rp. 200.000",
      price: "Rp. 150.000",
      img: img1,
    },
    {
      id: 2,
      title: "Action Cyber Strike",
      desc: "Hack, fight, and survive futuristic city battles.",
      oldPrice: "Rp. 180.000",
      price: "Rp. 130.000",
      img: img2,
    },
    {
      id: 3,
      title: "Action Galaxy Runner",
      desc: "Run through planets, defeat aliens, and save the galaxy.",
      oldPrice: "Rp. 160.000",
      price: "Rp. 120.000",
      img: img3,
    },
