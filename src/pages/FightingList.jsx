...
import img1 from "../assets/animefight.jpg";
import img2 from "../assets/slendrina.jpg";
import img3 from "../assets/nascar.jpg";
  ...
  const products = [
    {
      ...
      desc: "High-speed anime combat with ultimate skills and real-time duels.",
      oldPrice: "Rp. 200.000",
      price: "Rp. 150.000",
      img: img1,
    },
    {
      id: 2,
      title: "Street Champion X",
      desc: "Master combos and dominate street fighting tournaments.",
      oldPrice: "Rp. 180.000",
      price: "Rp. 130.000",
      img: img2,
    },
    {
      id: 3,
      title: "Fury Clash Warriors",
      desc: "Choose your fighter and battle across multiple arenas.",
      oldPrice: "Rp. 160.000",
      price: "Rp. 120.000",
      img: img3,
    },
    {
      id: 4,
      title: "Shadow Blade Duel",
      desc: "Ninja sword combat with fast-paced PVP fighting mechanics.",
      oldPrice: "Rp. 190.000",
      price: "Rp. 140.000",
      img: img1,
    },
    {
      id: 5,
      title: "Super Punch Heroes",
      desc: "Classic arcade punch battle with modern HD effects.",
      oldPrice: "Rp. 210.000",
      price: "Rp. 170.000",
      img: img2,
    },
    {
      ...
      desc: "Competitive 1v1 fighting with brutal finishers and combos.",
      oldPrice: "Rp. 220.000",
      price: "Rp. 180.000",
      img: img3,
    },
