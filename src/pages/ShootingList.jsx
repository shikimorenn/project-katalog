...
const ShootingList = () => {
  ...
  const products = [
    {
      id: 1,
      title: "Shooter Battlefield Online",
      desc: "FPS online dengan mode warzone penuh aksi.",
      oldPrice: "Rp. 230.000",
      price: "Rp. 190.000",
      img: img1,
    },
    {
      id: 2,
      title: "Sniper Elite Shadow",
      desc: "Tantang akurasi tinggi dalam mode misi sunyi.",
      oldPrice: "Rp. 210.000",
      price: "Rp. 170.000",
      img: img2,
    },
    {
      id: 3,
      title: "Modern Combat X",
      desc: "PVP shooter modern dengan grafik realistis.",
      oldPrice: "Rp. 200.000",
      price: "Rp. 150.000",
      img: img3,
    },
