...
const SportList = () => {
  ...
  const products = [
    {
      id: 1,
      title: "Football Champions Arena",
      desc: "Bangun tim impian dan kompetisi global.",
      oldPrice: "Rp. 180.000",
      price: "Rp. 140.000",
      img: img1,
    },
    {
      id: 2,
      title: "Basketball Street Online",
      desc: "Pertandingan basket cepat dengan gaya street.",
      oldPrice: "Rp. 170.000",
      price: "Rp. 130.000",
      img: img2,
    },
    {
      id: 3,
      title: "Ultimate Racing Sport",
      desc: "Balapan sport dengan mesin super kencang.",
      oldPrice: "Rp. 210.000",
      price: "Rp. 160.000",
      img: img3,
    },
