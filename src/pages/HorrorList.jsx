...
const HorrorList = () => {
  ...
  const products = [
    {
      id: 1,
      title: "Horror Nightmare Escape",
      desc: "Survive terrifying environments filled with monsters and puzzles.",
      oldPrice: "Rp. 220.000",
      price: "Rp. 180.000",
      img: img1,
    },
    {
      id: 2,
      title: "Ghost Mansion Hunter",
      desc: "Investigate haunted mansions filled with dark secrets.",
      oldPrice: "Rp. 200.000",
      price: "Rp. 150.000",
      img: img2,
    },
    {
      id: 3,
      title: "Zombie Silent City",
      desc: "Explore an abandoned city infested with the undead.",
      oldPrice: "Rp. 190.000",
      price: "Rp. 140.000",
      img: img3,
    },
    {
      ...
      desc: "Explore the abandoned house and uncover the source of terrifying hauntings.",
      oldPrice: "Rp. 300.000",
      price: "Rp. 250.000",
      img: img4,
    },
